...
def CreateDataset(opt):
    ...
    elif opt.dataset_mode == 'lowlight_dataset':
        from data.lowlight_dataset import LowlightDataset
        dataset = LowlightDataset()
    elif opt.dataset_mode == 'noise_dataset':
        from data.noise_dataset import BenchmarkTrain
        dataset = BenchmarkTrain(opt)
